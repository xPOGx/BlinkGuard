...
| `src/app.tsx` | Settings shell (`BlinkGuardHomepage`); Reminders Schedule/Pause; Camera Setup/Tuning; Progress tabs; Settings General/Data; About Overview/Notes/Thanks; Debug Preview/Tools |
