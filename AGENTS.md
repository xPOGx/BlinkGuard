...
| `src/app.tsx` | Settings shell (`BlinkGuardHomepage`); Reminders Schedule/Pause; Camera Setup/Tuning; Appearance (popup chrome, `notificationStyle`, sound); Progress tabs; Settings General/Data; About Overview/Notes/Thanks; Debug Preview/Tools |
