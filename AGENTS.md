...
| Path | Notes |
|---|---|
| `shared/` | IPC channel constants/whitelists + preference types/defaults, diagnostics export result, auto-update status (`auto-update.ts`), camera quality / EAR, blink-rate / blink-stats / blink-rewards, `i18n/` (no Electron imports) |
