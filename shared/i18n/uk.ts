...
export const uk: MessageCatalog = {
	...
	"about.opensource.body":
		"BlinkGuard — з відкритим кодом. Можна читати репозиторій, відкривати issues, ділитися ідеями чи долучатися на GitHub — це той самий репо, з якого зібрано додаток.",
