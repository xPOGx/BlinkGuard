...
export const uk: MessageCatalog = {
	...
	"camera.detectionDesc":
		"Увімкніть, щоб розблокувати нагадування за морганнями, живу статистику, коучинг і нагороди. Вимкнено = лише таймерні нагадування; ці функції камери залишаються неактивними.",
	...
	"profile.share.desc": "Збережи зображення картки профілю, щоб викласти або залишити собі.",
	...
	"profile.share.card.blinks": "{n} кліпів за весь час",
	"profile.share.card.streak": "стрік {n} дн.",
